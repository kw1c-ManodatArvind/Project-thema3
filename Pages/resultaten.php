...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    for ($i = 0; $i < count($vragen); $i++) {
        if (isset($_POST["antwoord$i"])) {
            ...
            $punten = 1; // Elke vraag krijgt standaard 1 punt
            ...
            } elseif ($i >= 1 && $i <= 16) { // Voor vraag 2 tot 16
                $punten = ($antwoord === $_POST["antwoord1"]) ? 0 : 1; // Eerste antwoord telt niet, de rest telt voor 1 punt
            }
            $antwoorden[] = $antwoord;
...
<div class="container">
    ...
    if (!empty($antwoorden)) {
        ...
        // Als het totale aantal punten onder de 40 ligt, toon dan een melding
        if ($totaalPunten < 40) {
